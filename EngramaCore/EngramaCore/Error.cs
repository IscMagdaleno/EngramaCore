namespace EngramaCore
{
	public sealed class Error
	{
		...
		private static string TimeoutErrorMsg => "El tiempo de espera se ha excedido en la base de datos, contacte al administrador para darle solución";
